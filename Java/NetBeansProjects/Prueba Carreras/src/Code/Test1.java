 ...
 * @author alanvega
 */
public class Test1 extends javax.swing.JFrame implements MouseMotionListener {
    ...
    public Test1() {
        ...
        try {
            URL urlImg = getClass().getResource("/images/background.png");
            background = ImageIO.read(urlImg);

            urlImg = getClass().getResource("/images/tree.png");
            tree = ImageIO.read(urlImg);

            urlImg = getClass().getResource("/images/tree2.png");
            tree2 = ImageIO.read(urlImg);

            urlImg = getClass().getResource("/images/car.png");
            car = ImageIO.read(urlImg);
            
            urlImg = getClass().getResource("/images/track.png");
            track = ImageIO.read(urlImg);
        } catch (Exception e) {
        }
