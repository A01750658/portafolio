...
public class IMC extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Introduce tu masa");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double masa = Integer.parseInt(jTextField1.getText());
        double altura = Integer.parseInt(jTextField2.getText());
        double imc = masa/Math.sqrt(altura); 
        jLabel3.setText("Tu Índice de Masa Corporal es:" + imc);
